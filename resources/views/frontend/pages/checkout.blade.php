...
<section class="shop checkout section">
    <div class="container">
        <form class="form" action="{{route('cart.order')}}" method="post">
          @csrf
          
          <div class="row">
            <div class="col-ls-8 col-12">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-md-6 col-12">
                            <div class="form-group">
                                ...
                                @error('address2')
                                    <span class="text-danger">{{$messsge}}</span>
                                @enderror
                            </div>
                        </div>
                    ...
                    <div class="single-widget">
                        ...
                        <div class="content">
                            <div class="checkbox">
                                ...
                                <for-group>
                                    <input type="radio" name="payment_method" value="cod"><label>Cash On Delivery</label> <br>
...
<section class="shop-service section home">
    <div class="container">
        <div class="row">
