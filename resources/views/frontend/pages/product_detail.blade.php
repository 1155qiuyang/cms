                                ...
                                <div class="col-12">
                                  ...
                                  <div class="ratting-main">
                                    <div class="avg-ratting">
                                        ...
                                        <span>Base on {{$product_tetail->getReivew->count()}} Comments</span>

                                    </div>
                                    @foreach ($product_tetail['getReview'] as $data)
...
<div class="product-area most-pupular related-product section">
    <div class="container">
        <div class="row">
            <div class="col-12">
        ...
        <div class="row">
            {{-- {{$product_tetail->rel_prods}} --}}
            <div class="col-12">
                <div class="owl-carousel popular-slider">
                    @foreach ($product_detail->rel_prods as $data)
                        @if ($data->id !==$product_tetail->id)
                        {{-- Start Single Product --}}
                            <div class="single-product">
                                <div class="prodoct-img">
