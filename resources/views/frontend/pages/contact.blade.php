                ...
                <div class="col-lg-8 col-12">
                    <div class="form-main">
                        <div class="title">
                            ...
                            @endphp
                            <h4>Get in touch</h4>
                            <h3>Write us a message @auth
                                @else <span style="font-size: 12px;" class="text-danger">[You need to login first]</span>
                            @endauth</h3>
                        </div>

                        <form class="form-contact form contact_form" action="{{route('contact.store')}}" method="post" id="contactForm" novalidate="novalidate">
                ...
                <div class="col-lg-4 col-12">
                    <div class="single-head">
                        <div class="single-info">
                            ...
                            <ul>
                                <li>@foreach ($settings as $data ) {{$data->phone}}
                        ...
                        <div class="single-info">
                            <i class="fa fa-location-arrow"></i>
                                ...
                                <ul>
                                    <li>@foreach ($settings as $data ){{$data->address}}
...
{{-- Start Shop Nesletter --}}
@include('frontend.layouts.newsletter')
{{-- End Shop Newsletter --}}

{{-- Contact Success --}}

<div class="model fade" id="success" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
